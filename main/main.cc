...
int main() {
    ...
    objects.push_back(std::make_shared<sphere_t>(sphere_t({0, -1002, 0}, 1000, color::white)));
    ...
    lights.push_back(std::make_shared<point_light_t>(point_light_t({-4, 3, 0}, 0.5, color::white, 1)));
